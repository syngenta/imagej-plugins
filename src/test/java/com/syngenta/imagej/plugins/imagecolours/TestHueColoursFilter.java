...
public class TestHueColoursFilter {
    ...
    public void testBaselines() {
        ...
        TestUtilities.testFilter(new HueColoursFilter(),
                TEST_IMAGE_DIR + "/clown.tif",
                TEST_IMAGE_DIR + "/clown-defaults.tif");
        ...
        TestUtilities.testFilter(
                ...
                TEST_IMAGE_DIR + "/clown.tif",
                TEST_IMAGE_DIR + "/clown-white_min=220 black_max=20 tolerance=40 light_dark_threshold=.4 saturation_min=.6 _white _black _grey make hide make_background.tif");
    }
